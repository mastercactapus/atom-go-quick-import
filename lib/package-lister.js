      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", [_path2.default.resolve(atom.config.get("go-quick-import.GOROOT") || env.GOROOT, "pkg", env.GOOS + "_" + env.GOARCH), _path2.default.resolve(atom.config.get("go-quick-import.GOPATH") || env.GOPATH, "pkg", env.GOOS + "_" + env.GOARCH)]);
