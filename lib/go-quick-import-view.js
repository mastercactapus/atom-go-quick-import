  ...
  _createClass(GoQuickImportView, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() /*: Promise*/ {
        var doList, importList, imports, existing, available, parts, items;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                _context.t3 = function (pkg) {
                  return imports[pkg];
                };

                parts = (0, _context.t1)(_context.t2, _context.t3);
